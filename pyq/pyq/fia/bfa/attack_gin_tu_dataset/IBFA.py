...
class InjectivityBFA(BFABase):
    ...
    def run_attack(self, model, data=None, target=None, max_flips=5):
        ...
        out1, out2 = model(x1, data1.edge_index, data1.batch)[is_labeled1], model(x2, data2.edge_index, data2.batch)[is_labeled2]
        ...
        for a in range(10):
            ...
            for name, module in model.named_modules():
                if isinstance(module, (TransformationLayerQuantizerWrapper, GenericLayerQuantizerWrapper)):
                    ...
                    output1 = model(x1, data1.edge_index, data1.batch)[is_labeled1]
                    output2 = model(x2, data2.edge_index, data2.batch)[is_labeled2]
                    quantize(model)
