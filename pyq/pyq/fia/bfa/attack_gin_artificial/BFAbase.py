...
class BFABase(object):
    ...
    def flip_bit(self, m):
        ...
        #print(m._wrapped_object.weight.grad is None, flush=True)
        #print(k_top, m._wrapped_object.weight.grad.detach().abs().view(-1).shape, flush=True)
        ...
        #print(self.n_bits2flip, b_grad_topk.abs().view(-1).shape, flush=True)
